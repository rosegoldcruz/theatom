...
function AeonArbitrageHomepage() {
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-8">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-gradient-to-br from-[#00a489] to-[#4cb99f] rounded-xl flex items-center justify-center shadow-lg">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-gradient-to-r from-[#00a489] to-[#4cb99f] text-white px-8 py-4 rounded-xl font-semibold hover:shadow-xl transition-all transform hover:scale-105 flex items-center justify-center space-x-2">
                  <span>Start Trading Now</span>
                  <ArrowRight className="w-5 h-5" />
                </button>
                <button className="border-2 border-[#00a489] text-[#00a489] px-8 py-4 rounded-xl font-semibold hover:bg-gradient-to-r hover:from-[#00a489]/5 hover:to-[#4cb99f]/5 transition-all flex items-center justify-center space-x-2">
            ...
            <div className="lg:pl-8">
              <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100 relative overflow-hidden">
                ...
                <div className="relative space-y-6">
                  ...
                  <button className="w-full border-2 border-[#00a489] text-[#00a489] py-3 rounded-lg font-semibold hover:bg-gradient-to-r hover:from-[#00a489]/5 hover:to-[#4cb99f]/5 transition-all">
                    Create Free Account
                  </button>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-5 gap-8 mb-12">
            <div className="col-span-2 space-y-4">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-gradient-to-br from-[#00a489] to-[#4cb99f] rounded-xl flex items-center justify-center">
                  <Activity className="w-6 h-6 text-white" />
                </div>
